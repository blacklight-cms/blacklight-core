...
module.exports=function(options){
	...
	var logger=global.bl.logger.get("blacklight-core.module-loader");
	...
	_.each(sites, function(site){
		if(!site.match(/\./)){
			...
			_.remove(projects, (val)=>{return (val==="node_modules") || val.indexOf(".")>-1});
				...
				_.each(files, function(file){
					...
					switch(file){
						...
						case "rooted-routes.js":
							...
							try{
								var curRouter=require(path)({templates: results.templates, express: express});
