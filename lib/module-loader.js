...
module.exports=function(options){
	...
	var results={templates:{}, libs:{}, modelHelpers:{}, router: router, rootedRouter: rootedRouter, routePaths:[]};
			...
			_.each(projects, function(project){		
				...
				_.each(files, function(file){
					...
					switch(file){
						...
						/////////////////////////////////////////////////////////////
						case "lib":
							results.libs[site]=results.libs[site]||{};
							results.libs[site][project]={};
							libs=fs.readdirSync(path);
							_.each(libs,function(lib){
								var reg=lib.match(/(.*)\.js/);
								results.libs[site][project][reg[1]]=require(_path.resolve(projectRoot,"lib",lib));
							});
