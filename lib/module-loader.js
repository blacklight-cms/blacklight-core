			...
			_.each(projects, function(project){		
				...
				if(hasRoutesJS || hasRoutesFolder){
					var routerSettings={
						...
						slingConnectors: options.slingConnectors, 
						getSlingByReq: function(req){return options.slingConnectors.getByReq(req).slingConnector;},
					...
					if(hasRoutesJS){
						var routesJS = require(_path.resolve(projectRoot,"routes.js"));
