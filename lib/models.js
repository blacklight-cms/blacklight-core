 ...
 */
exports.generatePageModel = function(slingPageContent, typeRegistry, utilities){
...
function isComponent(slingContent){
	return _.isObject(slingContent) && !_.isArray(slingContent) && (slingContent["_sling_resourceType"] ||  slingContent["sling:resourceType"]);
}
