...
module.exports = function(options){
	...
	var logger=global.bl.logger.get("blacklight-render.express");
		...
		if(req.path==="/favicon.ico"){
			...
			if(extension && !_.includes(supportedExtensions, extension)){
				...
				function processSling(slingData){
						...
						slingData.meta.blacklight.sling_source = requestedMode;
						slingData.meta.blacklight.site = req.blSite;
